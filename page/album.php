      ...
      <div class="col-2">
         <div class="card bg-secondary">
            <div class="card-body">
               ...
               // untuk menyimpan album yang dibuat oleh user
               if ($submit=='Simpan') { 
               ...
               ?>
               <!-- untuk mengedit album yang telah dibuat -->
                  ...
                  <tbody>
                     ...
                     <tr>
                        ...
                        <td>
                           ...
                           <a href="?url=kategori&&albumid=<?= $album['AlbumID'] ?>" class="btn btn-sm btn-secondary">Lihat Foto</a>
                        </td>
                     </tr>
                     <?php endforeach; ?>
                  </tbody>
