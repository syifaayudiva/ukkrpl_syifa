            ...
            <div class="card bg-secondary">
                <div class="card-body">
                    ...
                    if ($submit == 'Simpan') {
                        ...
                        if ($submit == "Ubah") { // contoh pemanggilan array untuk submit foto yang di upload
                            $judul_foto = @$_POST['judul_foto'];
                            $deskripsi_foto = @$_POST['deskripsi_foto'];
                            $nama_file = @$_FILES['namafile']['name'];
                            $tmp_foto = @$_FILES['namafile']['tmp_name'];
                            ...
                            if (strlen($nama_file) == 0) {
                                //contoh array pemanggilan variabel untuk update foto
                    ...
                    } elseif (isset($_GET['hapus'])) { // untuk menghapus foto yang sebelumnya telah di upload
            ...
            <div class="row">
                ...
                ?>
                    <div class="col-6 col-md-4 col-lg-3 mb-4">
                        <div class="card">
                            <img src="uploads/<?= $foto['LokasiFile'] ?>" class="object-fit" style="aspect-ratio: 16/9;">
                            <div class="card-body">
