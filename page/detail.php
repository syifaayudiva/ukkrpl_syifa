<!-- untuk memberi like dari tabel foto ke tabel likefoto -->
<?php 
...
<div class="container">
   <div class="row">
      <div class="col-6">
         <div class="card">
            ...
            <div class="card-body">
               ...
               if ($submit=='Kirim') {
                  $komen=mysqli_query($conn, "INSERT INTO komentarfoto VALUES('','$foto_id','$user_id','$komentar','$tanggal')"); // penggunaan function
               ...
               <form action="?url=detail" method="post">
                  <div class="form-group">
                     <?php if(isset($_SESSION['user_id'])): ?>
                        <input type="text" class="form-control flex-row" name="komentar" required placeholder="Tuliskan Komentar"><br>
                        <input type="submit" value="Kirim" name="submit" class="btn btn-warning">
                     <?php endif; ?>||
      ...
      <!-- untuk perintah komentar oleh user -->
      <div class="col-6">
         <?= @$alert ?>
         <?php $UserID=@$_SESSION["user_id"]; $komen=mysqli_query($conn, "SELECT * FROM komentarfoto INNER JOIN user ON komentarfoto.UserID=user.UserID INNER JOIN foto ON komentarfoto.FotoID=foto.FotoId WHERE komentarfoto.FotoID='$_GET[id]'"); // penggunaan stored procedure
